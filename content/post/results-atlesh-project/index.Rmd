...
![*Figure 1*. A visual network of the codes that comprise the seven major categories emerging from qualitative analysis. Conceptual similarity established the groupings. Two codes (Positive Review and Lifelines) were distinct enough to serve as categories. Aside from the largest category, Safe & Equitable Operations, the number of associated codes is not associated with the importance of a category. For instance, four codes comprise Community Member but most of these codes are poorly grounded and conceptually sparse. Produced with ATLAS.ti 8.](/img/ATLESH_code-network.png)
...
###Socialization of Rules

Clients struggle to adapt to rules. One woman harped on her peers in active addiction to dismiss her inability to find a job. In general, clients reported wanting more autonomy before they had earned it, citing peers who appear to be treated differently. Although deflection and defiance may be features of many client cognitions, one solution might be a chart or board in a common area showing the phase of each client. Both Grace and Trinity have four phases: one, get documentation; two, obtain income; three, save money; four, find permanent housing. A spectacle of this phase system during weekly house meetings might motivate clients to adjust quicker. It should be noted that one client welcomed a sanction she received for failing a drug test: “that helped me because that was my lesson learned.” Consequences need not feel good in the moment to be appreciated in hindsight.
...
Improvements to the curriculum should focus primarily on emotional, social, and spiritual development. Three of the clients mentioned a preference for learning to cope with unmanageable emotions. One client complained about the [*Financial Peace*](https://www.financialpeace.com/) lessons: 
...
Group interventions should be expanded to enhance the role of social support and teach clients how to form functional, resilient, and reciprocal networks. Presently, the benefits of group dynamics are limited to morning devotion, therapy, and mandatory twelve-step meetings.

###More Group Experiences

Eight participants recognized the sense of camaraderie developed during group experiences as a restorative condition. Charismatic, genuine group leaders facilitate powerful dynamics. Devotions unite the clients such that the “dayroom be actually kind of packed in the morning.” Even when pastors drop-in to “give us plants—that's real positive.” One client confessed his excitement to return to Tomorrow’s Hope on Mondays because groups are perceived to be rewarding. Replication of these positive moments might be achieved through partnership with the [Department of Counseling, Foundations, and Leadership](https://cfl.columbusstate.edu/) at Columbus State University. Masters-level students in the clinical mental health counseling program could be recruited, perhaps via collaboration with professors, to offer impromptu groups in exchange for documented clinical hours or elective credits.

The garden initiative at the Grace House functions as a means for some clients to contribute as teammates. A community garden on the main SafeHouse campus may be helpful, too. Other team experiences might be “a kickball game against the Trinity.” A homeless client raved about the success of a church-sponsored barbecue. The establishment of a kickball-barbecue would not only unite the clients but might also serve as a moment of publicity. One can imagine a kickball-barbecue pitting SafeHouse against [Valley Rescue Mission](https://www.valleyrescuemission.org/) or [Salvation Army](https://salvationarmygeorgia.org/columbus/) being equally successful. 

Peer-led activities might enhance the therapeutic impact at both transitional living facilities. Clients who participate in peer-support communities are less likely to relapse into substance abuse or homelessness (Boisvert, Martin, Grosek, & Clarie, 2008). SafeHouse could institute a senior peer system in which clients vote for a peer-leader each month from a panel of staff-nominated individuals. Nomination would be contingent upon phase level and general conduct. The senior peer would be responsible for facilitating nightly house meetings, weekend check-ins, and extracurricular events. For example, at the Trinity, volunteers host a game night on Fridays; the senior peer might do something similar. Staff could support this initiative by requiring participation, leading a monthly transition ceremony, and offering perks (e.g., extended curfew). Check-ins, Double Trouble in Recovery, and the twelve-step meeting on the first floor are other moments that foster a sense of brotherhood and sisterhood.

###Family

There is a desire for an ability to connect to family, biological or logical. Beginning with the latter, clients report that their sense of brotherhood and sisterhood erodes when dynamics change or peers relapse. A senior peer system might buffer against this deterioration. When other clients use the services as designed, they become role models who “really […] motivate.”

In terms of biological family, one client complained that he was unable to see his kids. This was due to his inability to secure a weekend pass. For new clients, weekend visitations may be possible. It may be important to encourage clients to ask their family members to bring them to church as a means of visiting without a pass.

###Empathy

Mutual empathy is one reason why group experiences are powerful. Examples include check-ins at Tomorrow's Hope and the twelve-step meeting on the first floor of the SafeHouse. Clients learn to ask others for help:
		
>“OK, this happened and this is what's going on, this is how I'm feeling. This is like...this is what I need the feedback on” (Client 0044).

Some clients lacked social support in earlier chapters of their lives. One man never learned to “empty out [his] trash.” Check-ins at Tomorrow’s Hope frequently emerged in conversation as a method to motivate clients to “keep going in [their] recovery.” The availability of the experience in memory is one explanation. Check-ins occur daily, so the activity is easily recalled. However, if SafeHouse replicates this experience in other areas of the ministry, clients may benefit.
...
Many of the requests that emerged revolved around reducing barriers to reentry and increasing comfort. One participant observed that older clients lack computer literacy. A simple solution would be posting flyers about [Columbus Technical College]( https://www.columbustech.edu/) or the [Goodwill Career Center](http://goodwillsr.org/career-center-locations/) around the SafeHouse to help clients become aware of free options. SafeHouse could offer an “incentive program” where clients could earn “points.” These points could be spent on raffles. Client self-esteem and motivation might increase if a volunteer of the month were commemorated on the first floor.  
...
SafeHouse offers a haven when homeless shelters are closed, encouraging the homeless population to congregate away from public spaces. The ministry could better promote the services at other locations (e.g., the shower program at [Open Door](https://opendoorcommunityhouse.org/)) via flyers. In addition to the mentorships, paid internships, and student involvement previously mentioned, SafeHouse should develop reentry pipelines with employers. Some employers with high turnover, such as [Alatrade](http://www.alatrade.com/), may be willing to give priority to clients of the SafeHouse if an agreement can be reached. The Executive Director mentioned a potential partnership with [Abel Electric](https://www.facebook.com/GodlyElectricians/). There may be other organizations, such as landscaping, moving, or cleaning companies, willing to hire clients who perform these activities for a set period at the ministry (i.e., volunteer only). That is, companies may agree to show a hiring preference for clients who receive a favorable recommendation of an in-demand skill. In return, the companies might reserve employment slots for SafeHouse clients. A system like this might qualify for funding from the [Emergency Solutions Grants](https://www.hudexchange.info/programs/esg/) (ESG) program.
